export default class View {
  ...
  changeCommandBtnsVisibility(hide = true) {
    Array.from(document.querySelectorAll('[name=command]'))
      .forEach(btn => {
        ...
        btn.classList[fn]('unassigned') //se hide for true, add unassigned, senão, remove
  ...
  notIsUnassignedButton(btn) {
    ...
    //!! retorna um boolean. ser retornar null (não achou), retorna false no lugar. 
    // Inverte com a ! no início para retornar true, pois não é um botão com unassigned button
  }
